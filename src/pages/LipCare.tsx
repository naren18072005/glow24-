...
const LipCare = () => {
  ...
  const { products, loading } = useProducts('lip-care');
      ...
      <main className="flex-grow pt-24">
        <div className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Premium Organic Lip Products</h2>
            <p className="text-white/80 max-w-2xl mx-auto">
              Discover our carefully formulated lip care products made with the finest organic ingredients.
              Your lips deserve nothing but the purest natural care.
            </p>
          </div>
